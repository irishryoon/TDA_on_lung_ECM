...
function compute_Dowker(P1, P2, min_size = 20)
    ...
    if (P1_size > min_size) & (P2_size > min_size)
        ...
        W_barcode0 = Eirene_var.barcode(W["eirene_output"], dim = 0) 
        W_barcode1 = Eirene_var.barcode(W["eirene_output"], dim = 1) 
...
# This is an old function used when the persistent images were of size 100 by 100 
